...
def bayes_theorem():
    ...
    p_spam_confirm = (p_confirm_spam * p_spam) / ((p_confirm_spam * p_spam) + (p_confirm_ham * p_ham))
    
    # 6. P( "정상 메일" | "확인" ) 의 확률을 구하세요.
    p_ham_confirm = (p_confirm_ham * p_ham) / ((p_confirm_spam * p_spam) + (p_confirm_ham * p_ham))
